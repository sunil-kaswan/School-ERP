...
class Qs
{
    ...
    {
        return self::getSetting('system_title') ?: 'SK.EduSoft Pro';
    }

    public static function getAllSession()
    {
        return Session::orderBy('name')->get(['id','name','is_current_session',]);
    }
 ...
 <div class="alert alert-success alert-bordered">
    ...
    public static function userIsSupportHelping()
    {
        return Auth::user()->user_type == 'support_helping';
    }
    ...
    {
        $data =  ['super_admin', 'admin', 'teacher', 'accountant', 'librarian', 'student', 'parent','support_helping'];
        return $remove ? array_values(array_diff($data, $remove)) : $data;
    }
    ...
    {
        $session = Session::where('is_current_session',1)->first('name','id');
