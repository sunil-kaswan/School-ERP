...
class UserController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $d['blood_groups'] = $this->user->getBloodGroups();
        $d['nationals'] = $this->loc->getAllNationals();
        $d['districts'] = $user->state_id? $this->loc->getDistricts($user->state_id): collect();
        $d['tehsils'] = $user->district_id? $this->loc->getTehsils($user->district_id): collect();
        $d['villages'] = $user->tehsil_id? $this->loc->getVillages($user->tehsil_id): collect();
