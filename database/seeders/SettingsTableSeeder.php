...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'SK.EduSoft Pro'],
            ['type' => 'system_name', 'description' => 'SK.EduSoft Pro'],
            ['type' => 'term_ends', 'description' => '7/10/2018'],
            ['type' => 'term_begins', 'description' => '7/10/2018'],
            ['type' => 'phone', 'description' => '7988671626'],
            ['type' => 'address', 'description' => 'Karmsana, Ellenabad'],
            ['type' => 'system_email', 'description' => 'kaswansunil26@gmail.com'],
