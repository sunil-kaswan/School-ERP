                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select onchange="getTehsil(this.value)" required data-placeholder="Choose.." class="select-search form-control" name="district_id" id="district_id">
                                    <option value=""></option>
                                    @foreach($districts as $st)
                                        <option {{ ($user->district_id == $st->id ? 'selected' : '') }} value="{{ $st->id }}">{{ $st->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select onchange="getVillage(this.value)" required data-placeholder="Choose.." class="select-search form-control" name="tehsil_id" id="tehsil_id">
                                    <option value=""></option>
                                    @foreach($tehsils as $st)
                                        <option {{ ($user->tehsil_id == $st->id ? 'selected' : '') }} value="{{ $st->id }}">{{ $st->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select data-placeholder="Choose.." class="select-search form-control" name="village_id" id="village_id">
                                    <option value=""></option>
                                    @foreach($villages as $st)
                                        <option {{ ($user->village_id == $st->id ? 'selected' : '') }} value="{{ $st->id }}">{{ $st->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
