<script>
    ...
    function getTehsil(district_id){
        var url = '{{ route('get_tehsil', [':id']) }}';
        url = url.replace(':id', district_id);
        var tehsil = $('#tehsil_id');
    ...
    function getVillage(tehsil_id){
        var url = '{{ route('get_village', [':id']) }}';
        url = url.replace(':id', tehsil_id);
