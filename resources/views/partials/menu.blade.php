        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                @if(Qs::userIsTeamSA())
                    ...
                    {{--Manage Staff--}}
                    <li class="nav-item">
                        <a href="{{ route('manage_staffs.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['manage_staffs.index', 'manage_staffs.show', 'manage_staffs.edit']) ? 'active' : '' }}"><i class="icon-users4"></i> <span> Manage Staff</span></a>
                    </li>
                    ...
                    {{--Manage Sessions--}}
                    <li class="nav-item">
                        <a href="{{ route('sessions.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['sessions.index','sections.edit',]) ? 'active' : '' }}"><i class="icon-fence"></i> <span>Sessions</span></a>
                    </li>
