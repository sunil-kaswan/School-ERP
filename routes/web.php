...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/set-current-sessions', [App\Http\Controllers\SupportTeam\SessionController::Class,'setCurrentSessions'])->name('set_current_sessions');
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::resource('manage_staffs', 'ManageStaffController');
    ...
    Route::group(['prefix' => 'ajax'], function() {
        ...
        Route::get('get_district/{state_id}', 'AjaxController@get_district')->name('get_district');
        Route::get('get_tehsil/{district_id}', 'AjaxController@get_tehsil')->name('get_tehsil');
        Route::get('get_village/{tehsil_id}', 'AjaxController@get_village')->name('get_village');
